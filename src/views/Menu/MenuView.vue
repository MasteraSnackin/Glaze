    ...
    <div id="view-menu" class="view active-view">
      ...
      <!-- Persona Header -->
        ...
        <div class="menu-group">
            <div class="section-header" data-i18n="section_settings">
Settings
</div>
            <div class="menu-item" @click="openSettings">
                ...
                <div class="menu-text" data-i18n="menu_app_settings">
App Settings
</div>
            </div>
...
{{ t('onboarding_replay') }}
            ...
            <div class="menu-item" @click="openBackupSheet">
                ...
                <div class="menu-text" data-i18n="menu_backups">
Backups
</div>
            </div>
            ...
            <div class="menu-item" @click="openSyncSheet">
                ...
                <div class="menu-text">
{{ t('menu_cloud_sync') || 'Cloud Sync' }}
</div>
            </div>
        </div>

        <div class="menu-group">
            <div class="section-header" data-i18n="section_info">
Info
</div>
